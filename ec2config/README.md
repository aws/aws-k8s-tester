...
| AWS_K8S_TESTER_EC2_ROLE_CFN_STACK_YAML_FILE_PATH       | read-only "true"  | *ec2config.Config.RoleCFNStackYAMLPath        | string                   |
...
| AWS_K8S_TESTER_EC2_VPC_CFN_STACK_YAML_FILE_PATH        | read-only "true"  | *ec2config.Config.VPCCFNStackYAMLPath         | string                   |
