...
type ConfigProwJobYAML struct {
	...
	AWSTESTER_EKS_KUBETEST_ENABLE_DUMP_CLUSTER_LOGS string
		...
		Presets: []config.Preset{
			{
				...
				Env: []v1.EnvVar{
					...
					{Name: "AWSTESTER_EKS_KUBETEST_ENABLE_DUMP_CLUSTER_LOGS", Value: cfg.AWSTESTER_EKS_KUBETEST_ENABLE_DUMP_CLUSTER_LOGS},
