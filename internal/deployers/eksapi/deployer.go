...
type deployerOptions struct {
	...
	EFA                         bool          `flag:"efa" desc:"Create EFA interfaces on the node of an unmanaged nodegroup. Only one instance type will be used if set. Requires --unmanaged-nodes."`
