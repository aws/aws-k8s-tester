// k8s-tester-secrets installs Kubernetes secrets tester.
package main
...
var rootCmd = &cobra.Command{
	Use:        "k8s-tester-secrets",
	Short:      "Kubernetes secrets tester",
	SuggestFor: []string{"secrets"},
}
...
func init() {
	...
	rootCmd.PersistentFlags().IntVar(&minimumNodes, "minimum-nodes", secrets.DefaultMinimumNodes, "minimum number of Kubernetes nodes required for installing this addon")
...
func createDeleteFunc(cmd *cobra.Command, args []string) {
	...
	fmt.Printf("\n*********************************\n")
	fmt.Printf("'k8s-tester-secrets delete' success\n")
}
