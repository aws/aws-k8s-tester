...
func init() {
	...
	rootCmd.PersistentFlags().IntVar(&minimumNodes, "minimum-nodes", metrics_server.DefaultMinimumNodes, "minimum number of Kubernetes nodes required for installing this addon")
