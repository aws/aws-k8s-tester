...
import (
	...
	sysdig "github.com/aws/aws-k8s-tester/k8s-tester/sysdig"
...
var rootCmd = &cobra.Command{
	...
	Short:      "Kubernetes Sysdig tester",
	SuggestFor: []string{"sysdig"},
}
...
func init() {
	...
	rootCmd.PersistentFlags().IntVar(&minimumNodes, "minimum-nodes", sysdig.DefaultMinimumNodes, "minimum number of Kubernetes nodes required for installing this addon")
	...
	rootCmd.PersistentFlags().StringVar(&accessKey, "access-key", "", "access Key for Sysdig helm chart")
	rootCmd.PersistentFlags().StringVar(&collectorEndpoint, "collector-endpoint", "", "Collector Endpoint is the url for your specfic sysdig collector to be pointed at")
...
func main() {
	if err := rootCmd.Execute(); err != nil {
		fmt.Fprintf(os.Stderr, "k8s-tester-sysdig failed %v\n", err)
		os.Exit(1)
	}
	os.Exit(0)
}
...
func newApply() *cobra.Command {
	...
	cmd.PersistentFlags().StringVar(&helmChartRepoURL, "helm-chart-repo-url", sysdig.DefaultHelmChartRepoURL, "helm chart repo URL")
	return cmd
}
...
func createApplyFunc(cmd *cobra.Command, args []string) {
	...
	fmt.Printf("\n*********************************\n")
	fmt.Printf("'k8s-tester-sysdig apply' success\n")
}
...
func createDeleteFunc(cmd *cobra.Command, args []string) {
	...
	fmt.Printf("\n*********************************\n")
	fmt.Printf("'k8s-tester-sysdig delete' success\n")
}
