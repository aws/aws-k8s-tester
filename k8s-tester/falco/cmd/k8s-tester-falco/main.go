// k8s-tester-falco installs Falcosecurity using helm, and tests that it's able to function correctly.
package main
...
var rootCmd = &cobra.Command{
	Use:        "k8s-tester-falco",
	Short:      "Kubernetes Falco tester",
	SuggestFor: []string{"falco"},
}
...
func init() {
	...
	rootCmd.PersistentFlags().IntVar(&minimumNodes, "minimum-nodes", falco.DefaultMinimumNodes, "minimum number of Kubernetes nodes required for installing this addon")
...
func createDeleteFunc(cmd *cobra.Command, args []string) {
	...
	fmt.Printf("\n*********************************\n")
	fmt.Printf("'k8s-tester-falco delete' success\n")
}
