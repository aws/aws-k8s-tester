// package vault installs vault charts.
...
const (
	...
	// chartRepoName               = "hashicorp/vault"
	// chartRepoURL                = "https://helm.releases.hashicorp.com"
	DefaultHelmChartRepoURL = "https://github.com/hashicorp/vault-helm/archive/refs/tags/v0.15.0.tar.gz"
)
...
func (ts *tester) Apply() error {
	...
	// 	return err
	// }
	if err := ts.createHelmVault(); err != nil {
		return err
	}
	return nil
}
...
func (ts *tester) Delete() error {
	...
	if err := ts.deleteHelmVault(); err != nil {
...
func (ts *tester) createHelmVault() error {
	...
	descArgsDs := []string{
		...
		"--namespace=" + ts.cfg.Namespace,
		"describe",
		"deployment.apps/vault-agent-injector",
	}
	...
	return helm.Install(helm.InstallConfig{
		...
		QueryFunc: func() {
			...
			if err != nil {
				...
				ts.cfg.Logger.Warn("Vault Tests::", zap.String("TEST", "FAILED"))
			}
...
func (ts *tester) deleteHelmVault() error {
