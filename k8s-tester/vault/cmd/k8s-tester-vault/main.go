// k8s-tester-vault installs vault using helm, and tests that it's able to function correctly.
package main
...
var rootCmd = &cobra.Command{
	Use:        "k8s-tester-vault",
	Short:      "Kubernetes Vault tester",
...
func init() {
	...
	rootCmd.PersistentFlags().IntVar(&minimumNodes, "minimum-nodes", vault.DefaultMinimumNodes, "minimum number of Kubernetes nodes required for installing this addon")
...
func newApply() *cobra.Command {
	...
	cmd.PersistentFlags().StringVar(&helmChartRepoURL, "helm-chart-repo-url", vault.DefaultHelmChartRepoURL, "helm chart repo URL")
	return cmd
}
...
func createDeleteFunc(cmd *cobra.Command, args []string) {
	...
	fmt.Printf("\n*********************************\n")
	fmt.Printf("'k8s-tester-vault delete' success\n")
}
