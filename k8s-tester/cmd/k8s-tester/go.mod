...
require (
	...
	github.com/aws/aws-k8s-tester/k8s-tester/aqua v0.0.0-00010101000000-000000000000 // indirect
	github.com/aws/aws-k8s-tester/k8s-tester/armory v0.0.0-00010101000000-000000000000 // indirect
	...
	github.com/aws/aws-k8s-tester/k8s-tester/kubecost v0.0.0-00010101000000-000000000000 // indirect
	...
	github.com/aws/aws-k8s-tester/k8s-tester/ondat v0.0.0-00010101000000-000000000000 // indirect
	...
	github.com/aws/aws-k8s-tester/k8s-tester/splunk v0.0.0-00010101000000-000000000000 // indirect
	github.com/aws/aws-k8s-tester/k8s-tester/stress v0.0.0-00010101000000-000000000000 // indirect
	github.com/aws/aws-k8s-tester/k8s-tester/sysdig v0.0.0-00010101000000-000000000000 // indirect
	github.com/aws/aws-k8s-tester/k8s-tester/tester v0.0.0-20211015221608-39044a62176f // indirect
	github.com/aws/aws-k8s-tester/k8s-tester/vault v0.0.0-00010101000000-000000000000 // indirect
	github.com/aws/aws-k8s-tester/k8s-tester/wordpress v0.0.0-00010101000000-000000000000 // indirect
...
replace (
	...
	github.com/aws/aws-k8s-tester/k8s-tester/ondat => ../../ondat
