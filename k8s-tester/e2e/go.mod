module github.com/aws/aws-k8s-tester/k8s-tester/e2e

go 1.16

require (
	github.com/aws/aws-k8s-tester/client v0.0.0-20210610170531-2e5d31e5196c
	github.com/aws/aws-k8s-tester/k8s-tester v0.0.0-20210616043244-fdb062e48d4c // indirect
	github.com/aws/aws-k8s-tester/k8s-tester/cloudwatch-agent v0.0.0-20210616043244-fdb062e48d4c // indirect
