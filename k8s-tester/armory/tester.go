...
const chartName = "armory"

const (
	DefaultMinimumNodes     int = 1
	DefaultHelmChartRepoURL     = "https://armory.jfrog.io/artifactory/charts/armory-spinnaker-operator-1.4.0.tgz"
)
...
func (ts *tester) Apply() error {
	...
	if err := ts.createHelmSpinnaker(); err != nil {
		return err
	}
...
func (ts *tester) Delete() error {
	...
	if err := ts.deleteHelmSpinnaker(); err != nil {
