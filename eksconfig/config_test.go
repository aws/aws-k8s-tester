...
func TestEnv(t *testing.T) {
	...
	os.Setenv("AWS_K8S_TESTER_EKS_AWS_K8S_TESTER_DOWNLOAD_PATH", "/tmp/aws-k8s-tester-test/aws-k8s-tester")
	...
	os.Setenv("AWS_K8S_TESTER_EKS_KUBECTL_DOWNLOAD_PATH", "/tmp/aws-k8s-tester-test/kubectl")
	...
	os.Setenv("AWS_K8S_TESTER_EKS_AWS_IAM_AUTHENTICATOR_DOWNLOAD_PATH", "/tmp/aws-k8s-tester-test/aws-iam-authenticator")
	...
	defer func() {
		...
		os.Unsetenv("AWS_K8S_TESTER_EKS_AWS_K8S_TESTER_DOWNLOAD_PATH")
		os.Unsetenv("AWS_K8S_TESTER_EKS_KUBECTL_DOWNLOAD_URL")
		os.Unsetenv("AWS_K8S_TESTER_EKS_KUBECTL_DOWNLOAD_PATH")
		os.Unsetenv("AWS_K8S_TESTER_EKS_AWS_IAM_AUTHENTICATOR_DOWNLOAD_URL")
		os.Unsetenv("AWS_K8S_TESTER_EKS_AWS_IAM_AUTHENTICATOR_DOWNLOAD_PATH")
	...
	if cfg.AWSK8sTesterDownloadPath != "/tmp/aws-k8s-tester-test/aws-k8s-tester" {
		t.Fatalf("unexpected AWSK8sTesterDownloadPath %q", cfg.AWSK8sTesterDownloadPath)
	}
	...
	if cfg.KubectlDownloadPath != "/tmp/aws-k8s-tester-test/kubectl" {
		t.Fatalf("unexpected KubectlDownloadPath %q", cfg.KubectlDownloadPath)
	}
	...
	if cfg.AWSIAMAuthenticatorDownloadPath != "/tmp/aws-k8s-tester-test/aws-iam-authenticator" {
		t.Fatalf("unexpected AWSIAMAuthenticatorDownloadPath %q", cfg.AWSIAMAuthenticatorDownloadPath)
	}
