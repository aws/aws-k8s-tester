...
func createDoc() string {
	...
	b.WriteByte('\n')
	b.WriteString(writeDoc(eksconfig.EnvironmentVariablePrefixAddOnJobPi, &eksconfig.AddOnJobPi{}))
	b.WriteByte('\n')
	b.WriteString(writeDoc(eksconfig.EnvironmentVariablePrefixAddOnJobEcho, &eksconfig.AddOnJobEcho{}))
	b.WriteByte('\n')
	b.WriteString(writeDoc(eksconfig.EnvironmentVariablePrefixAddOnCronJob, &eksconfig.AddOnCronJob{}))
	b.WriteByte('\n')
