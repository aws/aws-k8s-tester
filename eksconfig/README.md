...
| AWS_K8S_TESTER_EKS_ADD_ON_CSRS_LOCAL_REQUESTS_WRITES_SUMMARY_COMPARE_JSON_S3_KEY   | read-only "true"  | *eksconfig.AddOnCSRsLocal.RequestsWritesSummaryCompareJSONS3Key  | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_CSRS_LOCAL_REQUESTS_WRITES_SUMMARY_COMPARE_TABLE_S3_PATH | read-only "true"  | *eksconfig.AddOnCSRsLocal.RequestsWritesSummaryCompareTableS3Key | string                         |
*------------------------------------------------------------------------------------*-------------------*------------------------------------------------------------------*--------------------------------*
...
| AWS_K8S_TESTER_EKS_ADD_ON_CSRS_REMOTE_REQUESTS_WRITES_SUMMARY_COMPARE_JSON_S3_KEY   | read-only "true"  | *eksconfig.AddOnCSRsRemote.RequestsWritesSummaryCompareJSONS3Key  | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_CSRS_REMOTE_REQUESTS_WRITES_SUMMARY_COMPARE_TABLE_S3_PATH | read-only "true"  | *eksconfig.AddOnCSRsRemote.RequestsWritesSummaryCompareTableS3Key | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_CONFIGMAPS_LOCAL_REQUESTS_WRITES_SUMMARY_COMPARE_JSON_S3_KEY   | read-only "true"  | *eksconfig.AddOnConfigmapsLocal.RequestsWritesSummaryCompareJSONS3Key  | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_CONFIGMAPS_LOCAL_REQUESTS_WRITES_SUMMARY_COMPARE_TABLE_S3_PATH | read-only "true"  | *eksconfig.AddOnConfigmapsLocal.RequestsWritesSummaryCompareTableS3Key | string                         |
*------------------------------------------------------------------------------------------*-------------------*------------------------------------------------------------------------*--------------------------------*
...
| AWS_K8S_TESTER_EKS_ADD_ON_CONFIGMAPS_REMOTE_REQUESTS_WRITES_SUMMARY_COMPARE_JSON_S3_KEY   | read-only "true"  | *eksconfig.AddOnConfigmapsRemote.RequestsWritesSummaryCompareJSONS3Key  | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_CONFIGMAPS_REMOTE_REQUESTS_WRITES_SUMMARY_COMPARE_TABLE_S3_PATH | read-only "true"  | *eksconfig.AddOnConfigmapsRemote.RequestsWritesSummaryCompareTableS3Key | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_SECRETS_LOCAL_REQUESTS_WRITES_SUMMARY_COMPARE_JSON_S3_KEY   | read-only "true"  | *eksconfig.AddOnSecretsLocal.RequestsWritesSummaryCompareJSONS3Key  | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_SECRETS_LOCAL_REQUESTS_WRITES_SUMMARY_COMPARE_TABLE_S3_PATH | read-only "true"  | *eksconfig.AddOnSecretsLocal.RequestsWritesSummaryCompareTableS3Key | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_SECRETS_LOCAL_REQUESTS_READS_SUMMARY_COMPARE_JSON_S3_KEY    | read-only "true"  | *eksconfig.AddOnSecretsLocal.RequestsReadsSummaryCompareJSONS3Key   | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_SECRETS_LOCAL_REQUESTS_READS_SUMMARY_COMPARE_TABLE_S3_PATH  | read-only "true"  | *eksconfig.AddOnSecretsLocal.RequestsReadsSummaryCompareTableS3Key  | string                         |
*---------------------------------------------------------------------------------------*-------------------*---------------------------------------------------------------------*--------------------------------*
...
| AWS_K8S_TESTER_EKS_ADD_ON_SECRETS_REMOTE_REQUESTS_WRITES_SUMMARY_COMPARE_JSON_S3_KEY   | read-only "true"  | *eksconfig.AddOnSecretsRemote.RequestsWritesSummaryCompareJSONS3Key  | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_SECRETS_REMOTE_REQUESTS_WRITES_SUMMARY_COMPARE_TABLE_S3_PATH | read-only "true"  | *eksconfig.AddOnSecretsRemote.RequestsWritesSummaryCompareTableS3Key | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_SECRETS_REMOTE_REQUESTS_READS_SUMMARY_COMPARE_JSON_S3_KEY    | read-only "true"  | *eksconfig.AddOnSecretsRemote.RequestsReadsSummaryCompareJSONS3Key   | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_SECRETS_REMOTE_REQUESTS_READS_SUMMARY_COMPARE_TABLE_S3_PATH  | read-only "true"  | *eksconfig.AddOnSecretsRemote.RequestsReadsSummaryCompareTableS3Key  | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_STRESSER_LOCAL_REQUESTS_WRITES_SUMMARY_COMPARE_JSON_S3_KEY   | read-only "true"  | *eksconfig.AddOnStresserLocal.RequestsWritesSummaryCompareJSONS3Key  | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_STRESSER_LOCAL_REQUESTS_WRITES_SUMMARY_COMPARE_TABLE_S3_PATH | read-only "true"  | *eksconfig.AddOnStresserLocal.RequestsWritesSummaryCompareTableS3Key | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_STRESSER_LOCAL_REQUESTS_READS_SUMMARY_COMPARE_JSON_S3_KEY    | read-only "true"  | *eksconfig.AddOnStresserLocal.RequestsReadsSummaryCompareJSONS3Key   | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_STRESSER_LOCAL_REQUESTS_READS_SUMMARY_COMPARE_TABLE_S3_PATH  | read-only "true"  | *eksconfig.AddOnStresserLocal.RequestsReadsSummaryCompareTableS3Key  | string                         |
*----------------------------------------------------------------------------------------*-------------------*----------------------------------------------------------------------*--------------------------------*
...
| AWS_K8S_TESTER_EKS_ADD_ON_STRESSER_REMOTE_REQUESTS_WRITES_SUMMARY_COMPARE_JSON_S3_KEY   | read-only "true"  | *eksconfig.AddOnStresserRemote.RequestsWritesSummaryCompareJSONS3Key  | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_STRESSER_REMOTE_REQUESTS_WRITES_SUMMARY_COMPARE_TABLE_S3_PATH | read-only "true"  | *eksconfig.AddOnStresserRemote.RequestsWritesSummaryCompareTableS3Key | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_STRESSER_REMOTE_REQUESTS_READS_SUMMARY_COMPARE_JSON_S3_KEY    | read-only "true"  | *eksconfig.AddOnStresserRemote.RequestsReadsSummaryCompareJSONS3Key   | string                         |
...
| AWS_K8S_TESTER_EKS_ADD_ON_STRESSER_REMOTE_REQUESTS_READS_SUMMARY_COMPARE_TABLE_S3_PATH  | read-only "true"  | *eksconfig.AddOnStresserRemote.RequestsReadsSummaryCompareTableS3Key  | string                         |
