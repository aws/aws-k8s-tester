...
- Add [`eks/fluentd`](https://github.com/aws/aws-k8s-tester/pull/117).
- Support [ECR repository for `busybox` images to minimize docker hub dependency in `eks/cron-jobs`, `eks/fluentd`, `eks/jobs-echo`](https://github.com/aws/aws-k8s-tester/pull/117).
...
- Add [`AddOnFluentd`](https://github.com/aws/aws-k8s-tester/pull/117).
- Support [ECR repository for `busybox` images to minimize docker hub dependency in `AddOnCronJobs`, `AddOnFluentd`, `AddOnJobsEcho`](https://github.com/aws/aws-k8s-tester/pull/117).
